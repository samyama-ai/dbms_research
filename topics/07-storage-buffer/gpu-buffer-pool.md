...
- **[SOTA]** Shanbhag, Madden, Yu. *A Study of the Fundamental Performance Characteristics of GPUs and CPUs for Database Analytics (Crystal).* SIGMOD, 2020.
- **[SOTA]** Yogatama, Gowanlock, Tang. *Mordred: A Heterogeneous CPU-GPU Cache-Coherent Buffer Manager.* VLDB, 2022.
- **[SOTA]** Bansal, Buchbinder, Naor. *Randomized Competitive Algorithms for Generalized Caching.* STOC/SICOMP, 2008/2012.
