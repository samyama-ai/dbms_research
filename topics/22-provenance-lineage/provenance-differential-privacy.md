...
- **[SOTA]** Johnson, Near, Song. *Towards Practical Differential Privacy for SQL Queries.* VLDB 2018 (elastic sensitivity).
- **[SOTA]** Kotsogiannis et al. *PrivateSQL: A Differentially Private SQL Query Engine.* VLDB 2019.
- **[Survey]** Bun, Ullman, Vadhan. *Fingerprinting Codes and the Price of Approximate Differential Privacy.* SIAM J. Comput., 2018.
