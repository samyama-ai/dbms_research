...
- **[Foundational]** Leis et al. *How Good Are Query Optimizers, Really?* VLDB, 2015.
- **[SOTA]** Li, Wu, Yi, Zhang. *Wander Join: Online Aggregation via Random Walks.* SIGMOD, 2016.
- **[SOTA]** Kipf et al. *Learned Cardinalities: Estimating Correlated Joins with Deep Learning (MSCN).* CIDR, 2019.
- **[SOTA]** Yang et al. *NeuroCard: One Cardinality Estimator for All Tables.* VLDB, 2020.
- **[SOTA]** Wu, Shaikhha, et al. *FactorJoin: A New Cardinality Estimation Framework for Join Queries.* SIGMOD, 2023.
