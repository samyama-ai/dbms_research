...
- **[SOTA]** J. Du, S. Elnikety, W. Zwaenepoel. *Clock-SI: Snapshot Isolation for Partitioned Data Stores Using Loosely Synchronized Clocks.* SRDS, 2013.
- **[SOTA]** H. Mahmoud et al. *MaaT: Effective and Scalable Coordination of Distributed Transactions in the Cloud.* VLDB, 2014.
- **[Survey]** P. Viotti, M. Vukolić. *Consistency in Non-Transactional Distributed Storage Systems.* ACM Computing Surveys, 2016.
