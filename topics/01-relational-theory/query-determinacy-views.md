...
- **[Foundational]** A. Y. Levy, A. O. Mendelzon, Y. Sagiv, D. Srivastava. *Answering queries using views.* PODS, 1995.
- **[Foundational]** L. Segoufin, V. Vianu. *Views and queries: determinacy and rewriting.* PODS, 2005.
- **[SOTA]** A. Nash, L. Segoufin, V. Vianu. *Views and queries: determinacy and rewriting.* ACM TODS, 2010.
- **[SOTA]** T. Gogacz, J. Marcinkowski. *The hunt for a red spider: conjunctive query determinacy is undecidable.* LICS, 2015.
- **[SOTA]** R. Pottinger, A. Y. Halevy. *MiniCon: a scalable algorithm for answering queries using views.* VLDB Journal, 2001.
- **[Survey]** A. Y. Halevy. *Answering queries using views: a survey.* VLDB Journal, 2001.
