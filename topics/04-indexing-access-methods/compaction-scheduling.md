...
- **[Foundational]** G. Brodal, R. Fagerberg. *Lower Bounds for External Memory Dictionaries.* SODA, 2003.
- **[SOTA]** N. Dayan, S. Idreos. *Dostoevsky: Better Space-Time Trade-Offs for LSM-Tree Based Key-Value Stores.* SIGMOD, 2018.
- **[SOTA]** O. Balmau, et al. *SILK: Preventing Latency Spikes in Log-Structured Merge Key-Value Stores.* USENIX ATC, 2019.
