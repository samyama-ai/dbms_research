...
- **[Foundational]** Shannon, C. E. *A Mathematical Theory of Communication.* Bell System Technical Journal, 1948.
- **[Foundational]** Duda, J. *Asymmetric Numeral Systems (ANS).* arXiv:1311.2540, 2013.
- **[SOTA]** Lemire, D., Boytsov, L. *Decoding Billions of Integers per Second through Vectorization (SIMD-BP128/FastPFor).* Software: Practice and Experience, 2015.
- **[SOTA]** Afroozeh, A., Boncz, P. *The FastLanes Compression Layout.* VLDB, 2023.
- **[SOTA]** Kuschewski, M., Sauerwein, D., Alhomssi, A., Leis, V. *BtrBlocks: Efficient Columnar Compression for Data Lakes.* SIGMOD, 2023.
- **[Foundational]** Abadi, D., Madden, S., Ferreira, M. *Integrating Compression and Execution in Column-Oriented Database Systems.* SIGMOD, 2006.
