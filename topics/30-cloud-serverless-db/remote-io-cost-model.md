...
- **[Foundational]** P. G. Selinger et al. *Access Path Selection in a Relational DBMS.* ACM SIGMOD, 1979.
- **[Foundational]** A. Aggarwal, J. S. Vitter. *The Input/Output Complexity of Sorting and Related Problems.* CACM, 1988.
- **[SOTA]** D. Durner, V. Leis, T. Neumann. *Exploiting Cloud Object Storage for High-Performance Analytics.* PVLDB, 2023.
- **[SOTA]** R. Marcus et al. *Bao: Making Learned Query Optimization Practical.* ACM SIGMOD, 2021.
- **[Survey]** V. Leis et al. *How Good Are Query Optimizers, Really?* PVLDB, 2015.
