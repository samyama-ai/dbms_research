...
- **[Foundational]** C. Faloutsos, M. Ranganathan, Y. Manolopoulos. *Fast Subsequence Matching in Time-Series Databases (GEMINI).* SIGMOD, 1994.
- **[Foundational]** J. Shieh, E. Keogh. *iSAX: Indexing and Mining Terabyte Sized Time Series.* KDD, 2008.
- **[SOTA]** K. Zoumpatianos, S. Idreos, T. Palpanas. *ADS: the Adaptive Data Series Index.* VLDB Journal, 2016.
- **[SOTA]** M. Linardi, T. Palpanas. *ULISSE: ULtra Compact Index for Variable-Length Similarity Search.* ICDE, 2018 / VLDBJ.
- **[Foundational]** R. Weber, H.-J. Schek, S. Blott. *A Quantitative Analysis and Performance Study for Similarity-Search Methods in High-Dimensional Spaces.* VLDB, 1998.
- **[Survey]** T. Palpanas, V. Beckmann. *Report on Data Series Management.* SIGMOD Record, 2019.
