...
## 9. Key References
- **[Foundational]** Agrawal, Carey, Livny. *Concurrency Control Performance Modeling: Alternatives and Implications.* TODS, 1987.
- **[Foundational]** Gray, Homan, Korth, Obermarck. *A Straw Man Analysis of the Probability of Waiting and Deadlock.* IBM RJ, 1981.
- **[SOTA]** Yu, Bezerra, Pavlo, Devadas, Stonebraker. *Staring into the Abyss: An Evaluation of Concurrency Control with One Thousand Cores.* VLDB, 2014.
- **[SOTA]** Wang, Kimura. *Mostly-Optimistic Concurrency Control for Highly Contended Dynamic Workloads (MOCC).* VLDB, 2016.
- **[SOTA]** Wang, Ding, Mao, Liu, et al. *Polyjuice: High-Performance Transactions via Learned Concurrency Control.* OSDI, 2021.
- **[Survey]** Thomasian. *Concurrency Control: Methods, Performance, and Analysis.* ACM Computing Surveys, 1998.
