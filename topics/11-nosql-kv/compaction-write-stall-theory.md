...
- **[SOTA]** Dayan, N., Idreos, S. *Dostoevsky: Better Space-Time Trade-Offs for LSM-Tree Based KV Stores.* SIGMOD, 2018.
- **[SOTA]** Balmau, O., et al. *SILK: Preventing Latency Spikes in Log-Structured Merge Key-Value Stores.* USENIX ATC, 2019.
- **[SOTA]** Yu, J., et al. *ADOC: Automatically Harmonizing Dataflow for LSM-based KV Stores.* FAST, 2023.
- **[Foundational]** Bronson, N., et al. *Metastable Failures in Distributed Systems.* HotOS, 2021.
